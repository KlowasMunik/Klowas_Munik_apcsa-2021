...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		if (String.length == 0)
		{
			out.print("please write something");
		}
		String response = "";
		...
		else (statement.indexOf("mother") >= 0
		...
		else (statement.indexOf("soccer") >= 0
				|| statement.indexOf("football") >= 0
				|| statement.indexOf("baseball") >= 0
				|| statement.indexOf("basketball") >= 0)
		{
			response = "Tell me more about your sport interests.";
		}
		else (statement.indexOf("food") >= 0
				|| statement.indexOf("hungry") >= 0
				|| statement.indexOf("thirsty") >= 0
				|| statement.indexOf("yum") >= 0)
		{
			response = "Tell me more about your food interests";
		}
		}
